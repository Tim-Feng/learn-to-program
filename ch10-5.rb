...
num_now = num_start
while num_now > 2
  puts english_number(num_now).to_s + "bottles of beer on the wall, " + english_number(num_now).to_s + " bottles of beer!"
  num_now = num_now -1

  puts "Take one down, pass it around, " + english_number(num_now).to_s + " bottles of beer on the wall!"
